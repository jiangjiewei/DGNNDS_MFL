...
from datasets.my_dataset import My_Data_Set
...
def get_train_test_set(train_dir, test_dir, train_anno, test_anno, train_label=None, test_label=None,args = None):
    ...
    elif args.dataset == 'my_dataset': # 加载自己的数据集
        train_set = My_Data_Set(train_dir, train_anno, train_data_transform)
        test_set = My_Data_Set(test_dir, test_anno, test_data_transform)
    else:
